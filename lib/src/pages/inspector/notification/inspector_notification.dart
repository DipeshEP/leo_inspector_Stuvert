...
class InspectorNotificationPage extends StatefulWidget {
  const InspectorNotificationPage({Key? key}) : super(key: key);

  @override
  State<InspectorNotificationPage> createState() =>
      _InspectorNotificationPageState();
}

class _InspectorNotificationPageState
    extends State<InspectorNotificationPage> {
  ...
  getTrashNotifications() async{
    try{
      _trashNotificationList = await inspectorRepository.getTrashNotificationList();
      setState(() {});
    }
    catch(e){
      print(e.toString());
  ...
  getNotificationList() async{
    try{
      ...
      Response? response = await inspectorRepository.getNotificationList(inspector!.inspectorId);
      print(response);
                            ...
                            TextButton(
                              ...
                              onPressed: () {
                                setState(() {
                                  ...
                                  inspectorRepository.storeTrashNotificationList(_trashNotificationList);
...
*/
  ...
  deleteNotification(String id) async {
    try{
      ...
      Response? response = await inspectorRepository.deleteNotification(id);
